      ...
      {movies.map((movie) => (
        <div key={movie.id} className="w-full px-4 py-8">
          <section className="bg-gray dark:bg-gray-900">
            <div className="flex max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 bg-gray-700 rounded-xl">
              ...
              <div className="rounded-xl">
                <img
                  className="lg:mt-0 lg:col-span-5 lg:flex w-64 h-64 rounded-xl"
